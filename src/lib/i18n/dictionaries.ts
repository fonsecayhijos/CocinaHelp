...
export const dictionaries: Record<Locale, Dictionary> = {
      ...
      plans: [
        {
          ...
          price: "0 €",
          period: "",
          description: "Para probar CocinaHelp una vez.",
          features: [
        ...
        },
        {
          ...
          price: "5,99 €",
          period: "/mes",
          description: "Ideas de recetas cuando las necesites.",
          features: [
  ...
  de: {
    ...
    pricing: {
      title: "Pläne",
      subtitle: "Einmal kostenlos testen. Wenn’s passt: 5,99 € pro Monat.",
      plans: [
        {
          name: "Gratis",
          price: "0 €",
          period: "",
          description: "CocinaHelp einmal testen.",
          features: [
        ...
        },
        {
          ...
          price: "5,99 €",
          period: "/Monat",
          description: "Rezeptideen, wenn du sie brauchst.",
          features: [
      ...
      plans: [
        {
          ...
          price: "0 €",
          period: "",
          description: "Try CocinaHelp once.",
          features: [
            "1 query (text or one photo)",
        ...
        },
        {
          ...
          price: "5.99 €",
          period: "/month",
          description: "Recipe ideas whenever you need them.",
          features: [
            "Everyday queries",
