        ...
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          <div className="mt-6 space-y-4 text-brand-900/90 leading-relaxed">
            ...
            <p>
              ...
              jardinero o técnico. Tú eres responsable del cuidado de tus recetas e ingredientes.
            </p>
            <p>
            ...
            <p>
              El contenido, la marca y el software de CocinaHelp están protegidos. No está permitida su copia o reventa no autorizada.
            </p>
            <p>
